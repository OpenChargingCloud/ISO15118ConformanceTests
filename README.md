...
| [`docs/reports/`](docs/reports/README.md) | findings written up for the counterparty they belong to — **thirty-one filings across six projects**, each a draft for a person to send, with the reproduction that makes it confirmable |
