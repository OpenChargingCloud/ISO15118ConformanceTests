...
├─ WWCP_ISO15118_EXI/         class library
│   ├─ Exi/                             BitReader, BitWriter, ExiPrimitives
│   ├─ V2GTP/                           8-byte transport header
│   └─ AppProtocol/                     Messages + hand-written codec
├─ WWCP_ISO15118_EXI_SourceGenerator/   Roslyn generator (XSD → codec)
├─ WWCP_ISO15118_2/        ISO 15118-2 codec (5 XSDs → generated assembly)
│   └─ Schemas/                         V2G_CI_Msg{Def,Header,Body,DataTypes} + xmldsig
├─ WWCP_ISO15118_20.CommonMessages/  ISO 15118-20 CommonMessages codec
├─ WWCP_ISO15118_20.DC/              ISO 15118-20 DC codec
├─ WWCP_ISO15118_20.AC/              ISO 15118-20 AC codec
├─ WWCP_ISO15118_20.WPT/             ISO 15118-20 WPT codec
├─ WWCP_ISO15118_20.ACDP/            ISO 15118-20 ACDP codec
├─ WWCP_ISO15118_20.AC_DER_IEC/      ISO 15118-20 Amd 1: AC + DER (IEC) grammar variant
├─ WWCP_ISO15118_20.AC_DER_SAE/      ISO 15118-20 Amd 1: AC + DER (SAE) grammar variant
├─ WWCP_ISO15118_EXI_Dispatch/           V2GTP payload-type → codec dispatcher
...
├─ WWCP_ISO15118_EXI_Tests/             NUnit test project
│   ├─ Infrastructure/
...
`WWCP_ISO15118_2` assembly. It handles the real schema surface: multi-file /
...
Five independent, generated assemblies — `WWCP_ISO15118_20.CommonMessages`,
...
`WWCP_ISO15118_EXI_Dispatch` (`V2GTPDispatcher`) maps a V2GTP payload type to one of the
...
Every set has its own `V2GSignature` (`WWCP_ISO15118_20.{CommonMessages,DC,AC}`):
