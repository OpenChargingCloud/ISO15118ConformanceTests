...
namespace Vanaheimr.V2G.Exi.SourceGenerator.Emit
{
    ...
    internal sealed class CodecEmitter
    {
        ...
        public static string Emit(SchemaPlan plan, string ns, string codecClass) =>
        ...
        private string Run()
        {
            ...
            _sb.AppendLine("#pragma warning disable CS0162, CS8794");
        ...
        {
            _sb.Append("public static class ").AppendLine(_codecClass);
            _sb.AppendLine("{");
