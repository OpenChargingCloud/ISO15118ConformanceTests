...
// address/port is always explicit. See CliArgs.Usage for the two subcommands.
...
static async Task RunSeccAsync(CliArgs args)
{
...
static async Task RunEvccAsync(CliArgs args)
{
    TlsOptions? tls = null;
    if (args.UseTls)
    {
