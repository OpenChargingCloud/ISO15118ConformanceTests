...
| 4 | [phase4.md](phase4.md) | ISO 15118-20: Multi-Schema-Codecs (CommonMessages/DC/AC) + V2GTP-Dispatch | **läuft** (Schemasätze generieren + kompilieren, alle Zielnachrichten byte-exakt gegen cbV2G inkl. Decode/Roundtrip, `RationalNumber`-Helper, V2GTP-Payload-Type-Dispatcher mit Fehlerfällen, CommonMessages-Fragment-Codecs + `V2GSignature` secp521r1/SHA-512 — 2 von 6 Fragment-Elementen byte-exakt gegen cbV2G, Sign/Verify end-to-end. Offen: restliche 4 Fragment-Elemente byte-verifizieren, DC/AC-Signaturen, EXIficient-Cross-Check, siehe README „Was noch fehlt") |
