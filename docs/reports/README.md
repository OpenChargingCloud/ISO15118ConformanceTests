...
08-12, 08-13, 08-14 and 08-15 — of which **two are withdrawn** and thirty-four are sendable. The
arithmetic is written out here so nobody has to rediscover it: 36 files − 2 withdrawn = 34 sendable,
