...
**Forty-eight filings written across six projects — three of them withdrawn**, and four of the rest have
to be sent **twice**.
...
**thirty-six** report files now — the forty-fifth to forty-eighth filings were written on
08-12, 08-13, 08-14 and 08-15 — of which **three are withdrawn** and thirty-three are sendable. The
arithmetic is written out here so nobody has to rediscover it: 36 files − 3 withdrawn = 33 sendable,
carrying 47 issues. (On 2026-08-11 the file count and the sendable count were both thirty-two, which was
