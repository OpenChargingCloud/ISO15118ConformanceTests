...
101 request frame(s), 101 response frame(s).
...
| 9 | ServiceDiscoveryReq | ServiceDiscoveryRes | OK |
| 10 | ServiceDetailReq | ServiceDetailRes | OK |
| 11 | ServiceSelectionReq | ServiceSelectionRes | OK |
| 12 | DC_ChargeParameterDiscoveryReq | DC_ChargeParameterDiscoveryRes | OK |
| 13 | ScheduleExchangeReq | ScheduleExchangeRes | OK |
...
| 93 | DC_PreChargeReq | DC_PreChargeRes | OK |
| 94 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 95 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 96 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 97 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 98 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 99 | DC_WeldingDetectionReq | DC_WeldingDetectionRes | OK |
| 100 | SessionStopReq | SessionStopRes | OK |
