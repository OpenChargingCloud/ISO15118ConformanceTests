...
102 request frame(s), 102 response frame(s).
...
| 94 | DC_PreChargeReq | DC_PreChargeRes | OK |
| 95 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 96 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 97 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 98 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 99 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 100 | DC_WeldingDetectionReq | DC_WeldingDetectionRes | OK |
| 101 | SessionStopReq | SessionStopRes | OK |
...
- DC_CableCheckReq: 82× on the wire, 1× in the scenario
