...
368 request frame(s), 368 response frame(s).
...
| 367 | AuthorizationReq | AuthorizationRes | FAILED |

## Response codes other than OK

- `[367] AuthorizationRes` → **FAILED**
...
- AuthorizationReq: 363× on the wire, 1× in the scenario
