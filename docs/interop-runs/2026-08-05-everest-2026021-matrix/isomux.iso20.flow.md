...
63 request frame(s), 63 response frame(s).
...
| 55 | DC_PreChargeReq | DC_PreChargeRes | OK |
| 56 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 57 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 58 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 59 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 60 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 61 | DC_WeldingDetectionReq | DC_WeldingDetectionRes | OK |
| 62 | SessionStopReq | SessionStopRes | OK |
...
- DC_CableCheckReq: 45× on the wire, 1× in the scenario
