...
71 request frame(s), 71 response frame(s).
...
| 63 | DC_PreChargeReq | DC_PreChargeRes | OK |
| 64 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 65 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 66 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 67 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 68 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 69 | DC_WeldingDetectionReq | DC_WeldingDetectionRes | OK |
| 70 | SessionStopReq | SessionStopRes | OK |

## Against the declared flow — `iso20-dc-eim-sapboth (iso15118-20, dc)`
...
- DC_CableCheckReq: 52× on the wire, 1× in the scenario
