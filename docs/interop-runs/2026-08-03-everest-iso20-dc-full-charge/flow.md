...
113 request frame(s), 113 response frame(s).
...
| 107 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 108 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 109 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
...
- DC_CableCheckReq: 95× on the wire, 1× in the scenario
