...
105 request frame(s), 105 response frame(s).
...
| 7 | ServiceDiscoveryReq | ServiceDiscoveryRes | OK |
| 8 | ServiceDetailReq | ServiceDetailRes | OK |
| 9 | ServiceSelectionReq | ServiceSelectionRes | OK |
| 10 | DC_ChargeParameterDiscoveryReq | DC_ChargeParameterDiscoveryRes | OK |
| 11 | ScheduleExchangeReq | ScheduleExchangeRes | OK |
...
| 97 | DC_PreChargeReq | DC_PreChargeRes | OK |
| 98 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 99 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 100 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 101 | DC_ChargeLoopReq | DC_ChargeLoopRes | OK |
| 102 | PowerDeliveryReq | PowerDeliveryRes | OK |
| 103 | DC_WeldingDetectionReq | DC_WeldingDetectionRes | OK |
| 104 | SessionStopReq | SessionStopRes | OK |
...
- AuthorizationReq: 4× on the wire, 1× in the scenario
- DC_CableCheckReq: 85× on the wire, 1× in the scenario
