...
namespace Vanaheimr.V2G.Iso15118_20.AC_DER_SAE
{
    /// <summary>
    /// XMLDSig signing/verification for ISO 15118-20 AC_DER_SAE (Amendment 1 DER) — identical suite and
    /// shape to <see cref="Vanaheimr.V2G.Iso15118_20.CommonMessages.V2GSignature"/> (SHA-512 digests,
    ...
    public static class V2GSignature
    {
        ...
        public static byte[] SignedInfoFragment(SignedInfoType signedInfo)
        {
            ...
            while (true)
            {
                if (AcDerSaeCodec.EncodeFragment_SignedInfo(signedInfo, buf, out int n))
