...
using Vanaheimr.V2G.Iso15118_20.AC_DER_IEC;
using Vanaheimr.V2G.Iso15118_20.AC_DER_IEC.Generated;

namespace Vanaheimr.V2G.Exi.Tests
{
    /// <summary>
    /// ISO 15118-20 AC_DER_IEC XMLDSig signing/verification: same ECDSA-P521/SHA-512 suite as
    ...
    /// </remarks>
    [TestFixture]
    public class Iso15118_20AcDerIecSignatureTests
    {
        private static ReferenceType SignedElementReference(out byte[] fragment)
        {
            ...
            Assert.That(AcDerIecCodec.EncodeFragment_AC_ChargeParameterDiscoveryRes(content, buf, out int n), Is.True);
