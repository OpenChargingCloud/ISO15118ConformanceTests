...
{
    /// <summary>
    /// ISO 15118-20 DC XMLDSig signing/verification: same ECDSA-P521/SHA-512 suite as CommonMessages'
    /// (<see cref="Iso15118_20SignatureTests"/>), against DC's own <c>SignedInfo</c>/<c>V2GSignature</c>.
    /// The fragment octets are pinned to cbV2G in <see cref="Iso15118_20DcFragmentTests"/>.
    /// </summary>
    [TestFixture]
    public class Iso15118_20DcSignatureTests
    {
